        ...
        try:
            ...
            if len(response.data) > 0:
                ...
                for i in range(min(topFlights, len(response.data)) ):
                    ...
                    print("Price: ", price, currency, " Airline_code: ", airlinecode, " Airline_name: ",airlinename, "Airline_icao_code", icaoCode)
            ...
            aFlight = {"type": "flight", "airline_name": "TAP", "price": 87, "currency": "EUR",
                       "departure": "2024-11-11", "airline_code": "TP", "airline_icao_code": "TAP", "status": "success", "i":0}
